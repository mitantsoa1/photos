...
{
    #[Route('/product/{id}/add', name: 'add_product_photo')]
    // #[Route('/product/{id}/edit/{idPhoto}', name: 'edit_product_photo')]
    public function index(Request $request, int $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $dirPhotos = $this->getParameter('kernel.project_dir') . "/public/asset/images/products/$id";
    ...
    #[Route('/product/{id}/edit/{idPhoto}', name: 'edit_product_photo')]
    public function edit(Request $request, int $idPhoto): Response
    {
        return $this->render('product/editPhoto.html.twig', [
            'formAddPhotos' => '$form',
            'product' => '$product'
        ]);
    }
